...
#include "rs24g_ctl_sc1233_version.h"
...
RS_IF rs_ret_t rs_get_sensor_lib_ver(uint16_t *major_ver, uint16_t *minor_ver, uint16_t *revision, uint16_t *hotfix)
{
	...
	*major_ver = rs24g_ctl_sc1233_version_major;
	*minor_ver = rs24g_ctl_sc1233_version_minor;
	*revision = rs24g_ctl_sc1233_version_revision;
	*hotfix = rs24g_ctl_sc1233_version_hotfix;
